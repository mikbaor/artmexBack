...
const { createCarga, createUnloading, getAllCargas, getAllDescargas, getAllExports, csvCharges, csvDescargas, documentPdf } = require("../controllers/traspaleoController")
...
router.post("/pdcreate",auth, documentPdf)
